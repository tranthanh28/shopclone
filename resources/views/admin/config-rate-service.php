            ...
            <section class="col-lg-6 connectedSortable">
                ...
                <section class="col-lg-6 connectedSortable">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <ul>
                                <li>Bước 1: Truy cập vào <a href="https://5gsmm.com/ref/yxs8m" target="_blank">đây</a> để đăng ký tài khoản.</li>
                                <li>Bước 2: Nạp số dư vào tài khoản để sử dụng API.</li>
                                <li>Bước 3: Nhấn vào menu Account để copy API KEY.</li>
                                <li>Bước 4: Dán API KEY vừa copy vào ô Token trong website bạn.</li>
                                <li>Bước 5: Điều chỉnh giá dịch vụ theo ý bạn và bắt đầu sử dụng.</li>
                            </ul>
